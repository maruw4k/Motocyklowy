    ...
    public class KomisInitializer : MigrateDatabaseToLatestVersion<KomisContext, Configuration>
    {
        ...
        public static void SeedKomisData(KomisContext context)
        {
            ...
            var motory = new List<Motocykl>
            {
                ...
                new Motocykl() { CenaMotoru=768, KategoriaID = 1, NazwaMotoru = "Honda M45", MotocyklId = 6, RokProdukcji = 1958, OpisMotoru = "szybki", Uzywany = true,  NazwaPlikuObrazka="motor5.jpg", OpisSkrocony = "gf", Pojemnosc = 1300},
                ...
                new Motocykl() { CenaMotoru=4400, KategoriaID = 3, NazwaMotoru = "Subzero", MotocyklId = 11, RokProdukcji = 1994, OpisMotoru = "szybki", Uzywany = true,  NazwaPlikuObrazka="motor.jpg", OpisSkrocony = "fdfdy", Pojemnosc = 1900},
                ...
                new Motocykl() { CenaMotoru=22400, KategoriaID = 5, NazwaMotoru = "Daelim VC", MotocyklId = 12, RokProdukcji = 1958, OpisMotoru = "szybki", Uzywany = true,  NazwaPlikuObrazka="motor14.jpg", OpisSkrocony = "gf", Pojemnosc = 1800},
                new Motocykl() { CenaMotoru=4578, KategoriaID = 5, NazwaMotoru = "Junak M11", MotocyklId = 12, RokProdukcji = 1958, OpisMotoru = "szybki", Uzywany = true,  NazwaPlikuObrazka="motor13.jpg", OpisSkrocony = "gf", Pojemnosc = 1300},
                new Motocykl() { CenaMotoru=123, KategoriaID = 5, NazwaMotoru = "Suzuki MI3", MotocyklId = 12, RokProdukcji = 1958, OpisMotoru = "szybki", Uzywany = false,  NazwaPlikuObrazka="motor12.jpg", OpisSkrocony = "gf", Pojemnosc = 1300},
                new Motocykl() { CenaMotoru=456, KategoriaID = 5, NazwaMotoru = "Honda VT", MotocyklId = 12, RokProdukcji = 1958, OpisMotoru = "szybki", Uzywany = true,  NazwaPlikuObrazka="motor11.jpg", OpisSkrocony = "gf", Pojemnosc = 1300},
